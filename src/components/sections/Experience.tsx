...
const experiences = [
  {
    ...
    details: [
      'Guided 20+ students in mastering concepts like Java RMI, CORBA, and SOAP-based Web Services',
      'Facilitated weekly tutorials and 5+ lab sessions with practical exercises',
      'Evaluated assignments and projects, delivering feedback within 5 days',
    ],
    color: 'primary',
  },
  {
    ...
    details: [
      'Devised AI-driven workflow converting 50+ PPTs into video courses using LLMs & RAG, ~40% efficiency gain',
      'Benchmarked 4 LLMs achieving 25% higher script accuracy with GPT-3.5-Turbo',
      'Produced 10+ AI-based course modules, boosting content scalability by 3×',
    ],
    color: 'secondary',
  },
  {
  ...
  },
  {
    ...
    details: [
      'Prototyped 3+ mobile applications, accelerating iteration cycles by 50%',
      'Built Notes App with SQFLite for offline storage with zero data loss',
      'Delivered "Palm Box Cricket Booking System" increasing user engagement by ~40%',
    ],
    color: 'secondary',
  },
  {
    ...
    details: [
      'Led 4-member team creating PC health monitoring tool with Python Socket modules',
      'Implemented secure Django authentication, reducing login latency by ~30%',
      'Lowered system resource consumption by 40% on low-end devices',
    ],
    color: 'primary',
  },
];
